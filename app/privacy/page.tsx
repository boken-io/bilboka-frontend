  ...
  return (
    <main className="p-4 md:p-10 mx-auto max-w-5xl">
      <Card className="px-12">
        <h1 className="flow text-5xl font-extrabold mb-2">Privacy Policy</h1>
        <p className="text-gray-500">Last updated: December 31, 2023</p>
        <p className="my-4">
        ...
        <h2 className="text-4xl mt-6">Interpretation and Definitions</h2>
        <h3 className="text-3xl mt-4">Interpretation</h3>
        <p className="my-4">
        ...
        <h3 className="text-3xl mt-4">Definitions</h3>
        <p className="my-4">For the purposes of this Privacy Policy:</p>
        <ul
          role="list"
          className="marker:text-gray-600 list-disc ps-5 space-y-2 text-sm"
        >
          <li>
            <p>
          ...
          <li>
            <p>
              ...
              &lsquo;control&lsquo; means ownership of 50% or more of the
          ...
          <li>
            <p>
              <strong>Company</strong> (referred to as either &lsquo;the
              Company&lsquo;, &lsquo;We&lsquo;, &lsquo;Us&lsquo; or
              &lsquo;Our&lsquo; in this Agreement) refers to Bilboken.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Bilboken, accessible from{' '}
              <a
                className="underline"
                href={`${url}`}
        ...
        <h3 className="text-3xl mt-4">Types of Data Collected</h3>
        <h4 className="text-2xl mt-3">Personal Data</h4>
        <p className="my-4">
        ...
        <h4 className="text-2xl mt-3">Usage Data</h4>
        <p className="my-4">
        ...
        <h4 className="text-2xl mt-3">Tracking Technologies and Cookies</h4>
        <p className="my-4">
        ...
        <p className="my-4">
          Cookies can be &lsquo;Persistent&lsquo; or &lsquo;Session&lsquo;
          ...
          as You close Your web browser. Learn more about cookies on the{' '}
          <a
            className="underline"
        ...
        <h3 className="text-3xl mt-4">Use of Your Personal Data</h3>
        <p className="my-4">
        ...
        <h3 className="text-3xl mt-4">Retention of Your Personal Data</h3>
        <p className="my-4">
        ...
        <h3 className="text-3xl mt-4">Transfer of Your Personal Data</h3>
        <p className="my-4">
        ...
        <h3 className="text-3xl mt-4">Delete Your Personal Data</h3>
        <p className="my-4">
        ...
        <h3 className="text-3xl mt-4">Disclosure of Your Personal Data</h3>
        <h4 className="text-2xl mt-3">Business Transactions</h4>
        <p className="my-4">
        ...
        <h4 className="text-2xl mt-3">Law enforcement</h4>
        <p className="my-4">
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h4 className="text-2xl mt-3">Other legal requirements</h4>
        <p className="my-4">
        ...
        <h3 className="text-3xl mt-4">Security of Your Personal Data</h3>
        <p className="my-4">
        ...
        <h2 className="text-4xl mt-6">Children&apos;s Privacy</h2>
        <p className="my-4">
        ...
        <h2 className="text-4xl mt-6">Links to Other Websites</h2>
        <p className="my-4">
        ...
        <h2 className="text-4xl mt-6">Changes to this Privacy Policy</h2>
        <p className="my-4">
        ...
        <p className="my-4">
          ...
          &lsquo;Last updated&lsquo; date at the top of this Privacy Policy.
        </p>
        <p className="my-4">
        ...
        <h2 className="text-4xl mt-6">Contact Us</h2>
        <p className="my-4">
