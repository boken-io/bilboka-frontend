    ...
    <div className="h-3/5 grid justify-items-center content-center loader">
      ...
      >
        ...
        >
          ...
          />
          <path
            className={styles.car__line + ' ' + styles.car__line__top}
            d="M22.5 16.5H2.475"
            strokeWidth="3"
          />
          <path
            className={styles.car__line + ' ' + styles.car__line__middle}
            d="M20.5 23.5H.4755"
            strokeWidth="3"
          />
          <path
            className={styles.car__line + ' ' + styles.car__line__bottom}
            d="M25.5 9.5h-19"
            strokeWidth="3"
          />
        </g>
